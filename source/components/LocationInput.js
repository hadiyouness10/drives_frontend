    ...
    >
      ...
      <View style={[styles.inputDiv, { flex: isTyping ? 1 : 0 }]}>
        <View
          style={[
            styles.input,
            { marginBottom: isTyping === "startingLocation" ? 10 : 20 },
          ]}
        >
          <TextInput
          ...
          <TouchableOpacity
            onPress={() => setIsDroppingMarker("startingLocation")}
        ...
        <View
          style={{
            flex: 1,
            display: isTyping === "startingLocation" ? "flex" : "none",
            margin: 10,
          }}
        >
          <LocationSuggestions
        ...
        <View style={styles.input}>
          ...
          <TouchableOpacity
            onPress={() => setIsDroppingMarker("destination")}
            style={{ marginRight: 5 }}
          >
            <Icon name="location-pin" size={30} color="#404040" />
          </TouchableOpacity>
        ...
        >
          <Text
            style={{ height: 50, textAlignVertical: "center", fontSize: 18 }}
          >
            Number of seats
          </Text>
          <Picker
